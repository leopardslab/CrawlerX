  ...
  <div class="centered-container">
    <md-content class="md-elevation-3">
      <div class="title">
        ...
        <div class="md-title">CrawlerX</div>
        <div class="md-body-1">Distributed and Extensible Crawling Platform</div>
      </div>
      ...
      <div class="actions md-layout md-alignment-center-space-between" style="margin-bottom: 30px;">
        <p>
      ...
      <div
        style="margin-top: 30px; margin-bottom: -10px; text-align: center; color: black; white-space: nowrap;"
      >
        Froget Your Password ?
        <a v-b-modal.modal-forget-email class="nav-link login">Click Here</a>
      </div>
      <hr />
      <div style="margin-top: 30px; margin-bottom: -10px; text-align: center;">
        <div class="md-body-1">or Sign In with Google</div>
    ...
    <b-modal
      ...
      @ok="handleOk"
    >
      <b-form ref="form" @submit.stop.prevent="resetPassword">
        <div
          style=" padding:1px; text-align: justify;"
        >Please enter your email address below and we will send you information to change your password.</div>
        <b-form-group
          label="Enter Your Email:"
          label-for="email-input"
          invalid-feedback="Enter a a valid Email"
          :state="emailState"
        >
  ...
  methods: {
    ...
    forgetpassword: function () {
      if (this.emailState) {
        ...
        this.$nextTick(() => {
          this.$bvModal.hide("modal-forget-email");
        });
      }
    },
  },
